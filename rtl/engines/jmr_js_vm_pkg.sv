...
package jmr_js_vm_pkg;
    ...
    localparam int CODE_WORDS = 20480; // 2026-08-21(3): see parent
    ...
    localparam int MAX_OBJ = 960;      // 2026-08-21(2): 768 pegged in play; user wants ~1024
    localparam int OBJ_SLOTS = 32;
    localparam int MAX_ARR_SHORT = 1536;
    localparam int ARR_SHORT_CAP = 32;
    localparam int MAX_ARR_LONG = 12;  // 2026-08-21(3): see parent
    localparam int MAX_ARR = MAX_ARR_SHORT + MAX_ARR_LONG;
    localparam int ENV_DEPTH = 256;    // 2026-08-21 fit: measured peak 157 x1.63
